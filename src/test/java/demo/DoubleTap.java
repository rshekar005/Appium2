...
public class DoubleTap extends BaseTest {

    @Test
    public void openMenuUsingDoubleTap() throws MalformedURLException, InterruptedException {
        BaseTest baseTest = new BaseTest();
        baseTest.launchAndroid();
        WebElement openMenu = androidDriver.findElement(AppiumBy.accessibilityId("open menu"));
        doubleTap(openMenu, androidDriver);

    }

    public void doubleTap(WebElement element, AndroidDriver driver) throws MalformedURLException, InterruptedException {
